...
def retrieve_cfg(args, use_rlg_config=False):
    ...
    elif args.task == "ShadowHandGraspP":
        return os.path.join(args.logdir, "shadow_hand_grasp/{}/{}".format(args.algo,args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_grasp.yaml"
    elif args.task == "ShadowImitator":
        return os.path.join(args.logdir, "shadow_hand_grasp/{}/{}".format(args.algo,args.algo)), "cfg/{}/config.yaml".format(args.algo), "cfg/shadow_hand_imitator.yaml"
    else:
        warn_task_name()
...
def get_args(benchmark=False, use_rlg_config=False):
    custom_parameters = [
        ...
        {"name": "--task", "type": str, "default": "ShadowHandGrasp",
