...
def to_array(array, dtype=np.float32):
...
class SMPLXLayer(torch.nn.Module):
    ...
    def __init__(
        ...
        # custom ext
        use_jit: bool = False,
        use_body_upper_asset = None,
        use_body_left_hand_asset = None,
        use_body_right_hand_asset = None,
    ) -> None:
        super().__init__()
    ...
    def forward(
        ...
        # print('world_tsl',world_tsl)
        # print('body_shape',body_shape)
        # print('body_pose',body_pose)
        # print('left_hand_pose',left_hand_pose)
        # print('right_hand_pose',right_hand_pose)
        # print('expr_shape',expr_shape)
        ...
        # print('shape_components',shape_components)
        # print('full_pose',full_pose)
        # print('self.v_template',self.v_template)
        # print('shapedirs',shapedirs)
        # print('self.posedirs',self.posedirs)
        # print('self.J_regressor',self.J_regressor)
        # print('self.parents',self.parents)
        # print('self.lbs_weights',self.lbs_weights)
